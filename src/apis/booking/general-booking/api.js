...
const geteAvailableSlots = async ({ date, technician_id, booing_id }) => {
  const { data } = await ApiInstance.get("/bookings/available-slots", {
    params: { technician_id, date, booking_id: booing_id },
  });
  return { data };
};
