...
export default function ShowTenchnician() {
  ...
  const personalInfoData3 = useMemo(() => {
    ...
    return [
      ...
      { label: t("staff.surgeries_count"), value: oneData.data.surgeries_count?.toString() || "0" },
    ];
  }, [oneData, t]);
          ...
          <div className="flex items-center gap-4">
            <Can group={PERMISSION_GROUP.Employee} type={PERMISSION_ACTION.update}>
              <PrimaryButton
                ...
                onClick={() => navigate(`/staff/tenchnician/${id}`)}
              />
            </Can>
