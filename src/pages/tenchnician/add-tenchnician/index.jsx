  ...
  useEffect(() => {
    if (isEdit && employeeData?.data) {
      ...
      reset({
        ...
        appointment_date: formatDate(emp.appointment_date, "DD/MM/YYYY"),
        start_date: formatDate(emp.start_date, "DD/MM/YYYY"),
        ...
        surgeries_count: emp.surgeries_count,
      ...
      <Card otherStyle={"max-md:!w-full !w-[80%]"}>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            />
            <Input
              name="surgeries_count"
              control={control}
              placeholder={t("staff.surgeries_count")}
              error={errors.surgeries_count?.message}
              isNumberWithCommas
            />
            <Input
              name="address"
