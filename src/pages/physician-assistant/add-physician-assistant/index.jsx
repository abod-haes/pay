...
const AddPhysicianAssistant = () => {
  ...
  const TITLE = isAdd
    ? t("physician-assistant.add-physician-assistant")
    : // : isShow
      // ? t("staff.view-employee")
      t("physician-assistant.edit-physician-assistant");
...
export default AddPhysicianAssistant;
