...
export default function PhysicianAssistant() {
  ...
  const columns = useMemo(
    () => [
      ...
      { accessorKey: "employee", header: t("physician-assistant.physician-assistant") },
  ...
  const handleEdit = row => navigate(`/staff/physician-assistant/${row.id}`);
  ...
  const handleShow = row => navigate(`/staff/physician-assistant/${row.id}/show`);
  ...
  return (
    <div>
      <BreadCrumb
        title={t("physician-assistant.physician-assistant")}
        link={"/staff/physician-assistant"}
        onClick={() => navigate("/staff/physician-assistant/add")}
        buttonText={t("physician-assistant.add-physician-assistant")}
        hideBrimaryButton={
      ...
      {state.isDeleteModalOpen && (
        <DeleteModal
          ...
          title={t("physician-assistant.delete-physician-assistant")}
          warning={t("delayed.warning")}
          deleteText={t("physician-assistant.delete-physician-assistant")}
