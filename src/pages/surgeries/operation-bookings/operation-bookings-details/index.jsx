...
const OperationBookingDetails = () => {
    ...
    const menuItems = [
      {
        ...
        onClick: () =>
          navigate(`/surgeries/operation-bookings/eyebrow-transplant/${encryptId(dataToReset.id)}`),
        show:
          status !== "done" &&
          status !== "delayed" &&
          status !== "cancel" &&
  ...
  return (
    <div className="py-2 relative">
      <BreadCrumb
        isAdd
        title={t("surgeries.process-details") + " - " + t("surgeries.eyebrow-transplant")}
...
export default OperationBookingDetails;
