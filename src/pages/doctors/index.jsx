...
export default function Doctors() {
  ...
  const columns = useMemo(
    () => [
      ...
      { accessorKey: "employee", header: t("doctors.doctors") },
  ...
  const handleEdit = row => navigate(`/staff/doctor/${row.id}`);
  ...
  const handleShow = row => navigate(`/staff/doctor/${row.id}/show`);
  ...
  return (
    <div>
      <BreadCrumb
        ...
        link={"/staff/doctor"}
        onClick={() => navigate("/staff/doctor/add")}
        buttonText={t("doctors.add-doctor")}
        hideBrimaryButton={
      ...
      {state.isDeleteModalOpen && (
        <DeleteModal
          ...
          title={t("doctors.delete-doctor")}
          warning={t("delayed.warning")}
          deleteText={t("doctors.delete-doctor")}
